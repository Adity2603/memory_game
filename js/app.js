const icons = ['img/img1.jpeg','img/img2.jpeg','img/img3.jpeg','img/img4.jpeg'];
...
function matchChecker(e){
	...
	if (e.target.classList.contains('card') && !e.target.classList.contains('front-open')) {
		...
		if (clickCount === 2) {
			...
			document.getElementById('score-display').innerHTML = ((50/moves)*150)*0.01;
			// score =200;
